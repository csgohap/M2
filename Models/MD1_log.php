 ...
 *         -----
 *
 *           1] tags       | Связь n:m             | Получить коллекцию связанных с этой записью лога тегов
 *
...
// В. Класс-модель //
//-----------------//
class MD1_log extends Model { // implements ModelInterface
  ...
  //------------------//
    ...
    //-------//
      ...
      //---------//
      // - Связь n:m
      // - Получить коллекцию связанных с этой записью лога тегов
      public function tags()
      {
        return $this->belongsToMany('\M2\Models\MD2_tags', 'm2.md1000', 'id_lognote', 'id_tag');
      }
