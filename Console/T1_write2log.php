...
// Консольная команда //
//--------------------//
class T1_write2log extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm2:write2log {msg=Тестовое сообщение из artisan-команды m2:log} {tags=empty}';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Add record to log, bind this record with tags if needed';
