 ...
 *  Что делает
 *  ----------
 *    - Apply specified in settings limits to amount of data stored in the log
 *
 *  Аргументы
 *  ---------
 *
...
// Консольная команда //
//--------------------//
class T2_limitator extends Command
{
  ...
  // - TODO: настроить шаблон консольной команды
    ...
    protected $signature = 'm2:limitator';

  //-----------------------------//
  // 2. Описание artisan-команды //
  //-----------------------------//

    protected $description = 'Apply specified in settings limits to amount of data stored in the log';
